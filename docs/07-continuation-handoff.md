...
- `m1-phase-exit-coverage.json` 与 `report_m1_readiness.rb` 已把 30 个 M0→M1 inherited phase-exit IDs 逐项对账：当前 13 项有完整 fixture evidence，10 项 partial，7 项尚未实现，因此 readiness 明确为 blocked。
