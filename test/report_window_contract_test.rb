...
class ReportWindowContractTest < Minitest::Test
  WINDOWS = [
    { id: "morning", start: "2026-08-08T08:00:00+08:00", end: "2026-08-08T19:00:00+08:00" },
    { id: "evening", start: "2026-08-08T19:00:00+08:00", end: "2026-08-09T08:00:00+08:00" }
  ].freeze

  def test_half_open_boundaries_assign_exactly_once
    assert_equal "morning", M2::ReportWindowContract.assign("2026-08-08T08:00:00+08:00", WINDOWS)
    assert_equal "evening", M2::ReportWindowContract.assign("2026-08-08T19:00:00+08:00", WINDOWS)
    assert_raises(M2::ReportWindowContract::Error) do
      M2::ReportWindowContract.assign("2026-08-09T08:00:00+08:00", WINDOWS)
    end
  end
  ...
  def test_late_version_is_processing_backfill
    result = M2::ReportWindowContract.classify_processing(
      nominal_window: WINDOWS.first, version_available_at: "2026-08-08T19:03:00+08:00", actual_window_id: "evening"
    )
