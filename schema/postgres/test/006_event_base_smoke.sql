...
BEGIN
  ...
  IF table_count NOT IN (47, 62, 64, 85, 86, 87) THEN
    RAISE EXCEPTION 'expected 47 tables after EventBase migration (or 62/64/85/86/87 after M1 extensions), found %', table_count;
  END IF;
