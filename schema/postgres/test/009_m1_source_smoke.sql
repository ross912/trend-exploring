...
BEGIN
  ...
  IF table_count NOT IN (62, 64, 85, 86, 87) THEN
    RAISE EXCEPTION 'expected 62 tables after M1 source slice (or 64/85/86/87 after governance and vertical slices), found %', table_count;
  END IF;
