...
BEGIN
  ...
  IF table_count NOT IN (41, 64, 85, 86, 87, 90) THEN
    RAISE EXCEPTION 'expected 41 tables after standalone governance slice or 64/85/86/87/90 in full M1 stack, found %', table_count;
  END IF;
