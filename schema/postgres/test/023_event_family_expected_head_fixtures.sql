...
INSERT INTO event_transition_state VALUES
  ('91000000-0000-4000-8000-000000000023',
   'm1.event-registry.ctr013.v1', 'RADAR_PUBLICATION',
   'RADAR_PUBLICATION_LIFECYCLE',
   '92000000-0000-4000-8000-000000000023', 1, NULL, 'active'),
  ('91000000-0000-4000-8000-000000000024',
   'm1.event-registry.ctr013.v1', 'RADAR_PUBLICATION',
   'RADAR_PUBLICATION_LIFECYCLE',
   '92000000-0000-4000-8000-000000000023', 2, 'active', 'superseded'),
  ('91000000-0000-4000-8000-000000000025',
   'm1.event-registry.ctr013.v1', 'REVOCATION_EPOCH',
   'REVOCATION_EPOCH_LIFECYCLE',
   '92000000-0000-4000-8000-000000000024', 1, NULL, 'current');
